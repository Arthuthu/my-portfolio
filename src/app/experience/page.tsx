                    ...
                    <Disclosure key={idx} defaultOpen={true}>
                        {({ open }) => (
                            <div className="border border-gray-400 shadow-sm">
                                <DisclosureButton
                                    className="flex w-full justify-between bg-gray-100 px-4 py-3 text-left text-lg font-medium hover:bg-gray-200 dark:bg-[var(--background-gray)] dark:bg-[var(--background-light-gray)] transition"
                                >
                                    <span>
